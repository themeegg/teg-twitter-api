            ...
            <li>
                <div class="teg-ta-user-logo">
                    <a href="https://twitter.com/<?php echo esc_attr($twitter_username); ?>" target="_blank">
                        <img src="<?php
                        echo esc_attr($twitter_feeds_array['user']['profile_image_url_https']);
                        ?>"/></a></div>
                <div class="teg-ta-single-feeds">
                    <h5><a href="https://twitter.com/<?php echo esc_attr($twitter_username); ?>"
                           target="_blank"><span
                                    class="teg-ta-account-name"><?php echo esc_attr($twitter_feeds_array['user']['name']) ?></span>
                            <span class="teg-ta-user-name">@<?php echo esc_attr($twitter_username) ?></span></a>
                    </h5>
                    <p><?php echo(teg_ta_twitter_feed_text_render($twitter_feeds_array)); ?></p>
                    <div class="teg-ta-feeds-actions">

                        <span class="teg-ta-feed-like"><a target="_blank"
                                                          href="https://twitter.com/intent/like?tweet_id=<?php echo esc_attr($twitter_feeds_array['id_str']) ?>"
                                                          title="<?php __('Like', 'teg-twitter-api') ?>"><?php __('Like', 'teg-twitter-api') ?></a></span>
                        <span class="teg-ta-feed-share"><a target="_blank"
                                                           href="https://twitter.com/intent/retweet?tweet_id=<?php echo esc_attr($twitter_feeds_array['id_str']) ?>"
                                                           title="<?php __('Share', 'teg-twitter-api') ?>"><?php __('Share', 'teg-twitter-api') ?></a></span>

                        <span class="teg-ta-feed-post-time"
                              title="<?php echo esc_attr($twitter_feeds_array['created_at']); ?>"><?php echo date('M-d', strtotime(esc_attr($twitter_feeds_array['created_at']))) ?></span>
                    </div>
                </div>
